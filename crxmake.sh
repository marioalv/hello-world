...
key=$KEY
name=$(basename "$dir")
crx="hello-world-$CURRENT_VERSION-$CHROME$EXTENSION"
pub="$name.pub"
sig="$name.sig"
zip="hello-world-$CURRENT_VERSION-$CHROME.zip"
xpiFirefox="hello-world-$CURRENT_VERSION-$FIREFOX.xpi"
